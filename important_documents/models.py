...
class Important_Documents(TranslatableMixin, models.Model):
...
class ImportantDocumentTranslation(models.Model):
    important_document = models.ForeignKey(Important_Documents, on_delete=models.CASCADE, related_name="translations")
    language = models.ForeignKey(Language, on_delete=models.CASCADE, related_name="important_document_translations")
